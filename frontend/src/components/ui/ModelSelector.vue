...
<template>
  <div :class="cn('relative', props.class)">
    <select
      ...
      class="w-full appearance-none rounded-xl border border-zinc-300 bg-white px-4 py-2.5 pr-10 text-sm font-medium text-zinc-900 shadow-sm transition-all hover:border-zinc-500 focus:border-zinc-500 focus:outline-none focus:ring-4 focus:ring-[rgba(113,113,122,0.35)] disabled:cursor-not-allowed disabled:opacity-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:hover:border-zinc-400 dark:focus:border-zinc-400"
      @change="handleChange"
    >
