          ...
          <div class="mb-2 flex items-center gap-2">
            <template v-if="editingTitle">
              <input
                ...
                name="title"
                autocomplete="off"
                class="title-input flex-1 rounded-md border border-zinc-300 bg-white px-3 py-1.5 text-sm font-medium text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-2 focus:ring-[rgba(113,113,122,0.35)] dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100"
                placeholder="输入会话标题..."
